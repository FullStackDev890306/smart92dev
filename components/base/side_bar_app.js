      ...
      >
        ...
        <div
          className={
            ...
            " w-max py-0.5 px-1.5 absolute top-1.5 right-full ml-3 m-1 text-ubt-grey text-opacity-90 text-sm bg-ub-grey bg-opacity-70 border-gray-400 border border-opacity-40 rounded-md"
          }
        >
          {this.props.title}
        </div>
